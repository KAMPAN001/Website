/**
* This function drowing time courses (FORWARD)
...
function converter_FORWARD(width, height, inputMin, inputMax, inputStep, inputDefaultValue, minValueX, maxValueX, precisionX, minValueY, maxValueY, precisionY, minValueX2, maxValueX2, precisionX2, minValueY2, maxValueY2, precisionY2, gridHorizontalSpace, gridVerticalSpace, gridHorizontalSpace2, gridVerticalSpace2, graduationHorizontalSpace, graduationVerticalSpace, graduationHorizontalSpace2, graduationVerticalSpace2, inputMin2, inputMax2, inputStep2, inputDefaultValue2, firstPlotColor, firstPlotColor2, firstPlotColor3, firstPlotColor4, firstPlotColor5, firstPlotColor6, secondPlotColor, secondPlotColor2, secondPlotColor3) {
    ...
    var container = createDiv("FORWARD");
    ...
    valueSlider.oninput = function () {
        ...
        //#region basic charts fo BOOST in the time (t)
        values = calculateForwardu2(this.value, minValueX, maxValueX - 0.001, 0.001, valueSlider2.value);
        values2 = calculateForwarduD2(this.value, minValueX, maxValueX - 0.001, 0.001, valueSlider2.value);
        values3 = calculateForwarduL(this.value, minValueX, maxValueX - 0.001, 0.001, valueSlider2.value);
        values4 = calculateForwardiL(this.value, minValueX, maxValueX, 0.001, valueSlider2.value);
        values5 = calculateForwardiC(this.value, minValueX, maxValueX, 0.001, valueSlider2.value);
        values6 = calculateForwardi2(this.value, minValueX, maxValueX - 0.001, 0.001, valueSlider2.value);
        values7 = calculateForwardu0(this.value, minValueX, maxValueX, 0.001, valueSlider2.value);
        ...
        drawText("u", 14, TextAlign.Left, TextBaseLine.Middle, false, true, zero[0].x + (values[Math.floor(values.length / 2)].x / (maxValueX - minValueX)) - 30, invertYAxis(zero[0].y, (values[Math.floor(this.value.length)].y / (maxValueY - minValueY))) - 20, context, "2");
        ...
        drawText("u", 14, TextAlign.Left, TextBaseLine.Middle, false, true, zero[0].x + (values[Math.floor(values.length / 2)].x / (maxValueX - minValueX)) - 30, invertYAxis(zero[0].y, (values[Math.floor(this.value.length)].y / (maxValueY - minValueY))) + 70, context, "D2");
        plot(values2, zero, minValueX, maxValueX, minValueY, maxValueY, width, height, 2, LineStyle.Solid, firstPlotColor2, context);
        drawText("u", 14, TextAlign.Left, TextBaseLine.Middle, false, true, zero[0].x + (values[Math.floor(values.length / 2)].x / (maxValueX - minValueX)) + 700, invertYAxis(zero[0].y, (values[Math.floor(this.value.length)].y / (maxValueY - minValueY))) + 70, context, "o");
        plot(values7, zero, minValueX, maxValueX, minValueY, maxValueY, width, height, 2, LineStyle.Solid, firstPlotColor4, context);
        drawAxes("", "t", width, height, 0, minValueY + 200, 0, maxValueY + 200, context, Color.Black, 2, LineStyle.Solid);
        drawText("u", 14, TextAlign.Left, TextBaseLine.Middle, false, true, zero[0].x + (values[Math.floor(values.length / 2)].x / (maxValueX - minValueX)) - 30, invertYAxis(zero[0].y, (values[Math.floor(this.value.length)].y / (maxValueY - minValueY))) + 150, context, "L");
        ...
        drawText("i", 14, TextAlign.Left, TextBaseLine.Middle, false, true, zero[0].x + (values[Math.floor(values.length / 2)].x / (maxValueX - minValueX)) - 30, invertYAxis(zero[0].y, (values[Math.floor(this.value.length)].y / (maxValueY - minValueY))) + 315, context, "C");
        ...
        drawText("i", 14, TextAlign.Left, TextBaseLine.Middle, false, true, zero[0].x + (values[Math.floor(values.length / 2)].x / (maxValueX - minValueX)) - 30, invertYAxis(zero[0].y, (values[Math.floor(this.value.length)].y / (maxValueY - minValueY))) + 400, context, "2");
