/**
* This function drowing time courses (BOOST)
...
function converter_BOOST_impuls_operation_in_time(width, height, inputMin, inputMax, inputStep, inputDefaultValue, minValueX, maxValueX, precisionX, minValueY, maxValueY, precisionY, minValueX2, maxValueX2, precisionX2, minValueY2, maxValueY2, precisionY2, gridHorizontalSpace, gridVerticalSpace, gridHorizontalSpace2, gridVerticalSpace2, graduationHorizontalSpace, graduationVerticalSpace, graduationHorizontalSpace2, graduationVerticalSpace2, inputMin2, inputMax2, inputStep2, inputDefaultValue2, firstPlotColor, firstPlotColor2, firstPlotColor3, firstPlotColor4, firstPlotColor5, firstPlotColor6, secondPlotColor, secondPlotColor2, secondPlotColor3) {
    ...
    var container = createDiv("BOOSTimpuls");
    ...
    valueSlider.oninput = function () {
        ...
        values = calculateBoostVLimpuls(this.value, minValueX, maxValueX, 0.001, valueSlider2.value);
        values2 = calculateBoostVDimpuls(this.value, minValueX, maxValueX, 0.001, valueSlider2.value);
        values3 = calculateBoostVTimpuls(this.value, minValueX, maxValueX, 0.001, valueSlider2.value);
        values4 = calculateBoostILimpuls(this.value, minValueX, maxValueX, 0.001, valueSlider2.value);
        values5 = calculateBoostITimpuls(this.value, minValueX, maxValueX, 0.001, valueSlider2.value);
        values6 = calculateBoostIDimpuls(this.value, minValueX, maxValueX, 0.001, valueSlider2.value);
