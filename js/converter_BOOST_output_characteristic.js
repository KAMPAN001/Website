/**
* Function drowsing output characteristic (B0OST)
...
*/
function converter_BOOST_output_characteristic(width, height, inputMin, inputMax, inputStep, inputDefaultValue, minValueX, maxValueX, precisionX, minValueY, maxValueY, precisionY, gridHorizontalSpace, gridVerticalSpace, graduationHorizontalSpace, graduationVerticalSpace, firstPlotColor, secondPlotColor, secondPlotColor2, secondPlotColor3) {
    ...
    var container = createDiv("BOST_output");
    ...
    valueSlider.oninput = function () {
        ...
        values = calculateBoostOutputCharacteristic(this.value, minValueX + 0.02, maxValueX, 0.001);
        values2 = calculateBoostOutputCharacteristicLine1();
        values3 = calculateBoostOutputCharacteristicLine2();
        context.fillStyle = "#ffffff";
        context.fillRect(0, 0, canvas.width, canvas.height);
        var zero = drawAxes("V0/Vin", "---I0/Iref", width, height, minValueX, minValueY, maxValueX, maxValueY, context, Color.Black, 2, LineStyle.Solid);
        ...
        plot(values3, zero, minValueX, maxValueX, minValueY, maxValueY, width, height, 2, LineStyle.Dotted2, secondPlotColor, context);
