/**
* This function drowing time courses (BUCK_impuls)
...
function converter_BUCK_impuls_operation_in_time(width, height, inputMin, inputMax, inputStep, inputDefaultValue, minValueX, maxValueX, precisionX, minValueY, maxValueY, precisionY, minValueX2, maxValueX2, precisionX2, minValueY2, maxValueY2, precisionY2, gridHorizontalSpace, gridVerticalSpace, gridHorizontalSpace2, gridVerticalSpace2, graduationHorizontalSpace, graduationVerticalSpace, graduationHorizontalSpace2, graduationVerticalSpace2, inputMin2, inputMax2, inputStep2, inputDefaultValue2, firstPlotColor, firstPlotColor2, firstPlotColor3, firstPlotColor4, firstPlotColor5, firstPlotColor6, secondPlotColor, secondPlotColor2, secondPlotColor3) {
    ...
    var container = createDiv("BUCK_impuls");
    ...
    valueSlider.oninput = function () {
        ...
        values = calculateBuckVLimpuls(this.value, minValueX, maxValueX - 0.001, 0.001, valueSlider2.value);
        values2 = calculateBuckILimpuls(this.value, minValueX, maxValueX, 0.001, valueSlider2.value);
        ...
        drawText("I", 14, TextAlign.Left, TextBaseLine.Middle, false, true, zero[0].x + (values[Math.floor(values.length / 2)].x / (maxValueX - minValueX)) - 30, invertYAxis(zero[0].y, (values[Math.floor(this.value.length)].y / (maxValueY - minValueY))) + 75, context, "L");
        plot(values2, zero, minValueX, maxValueX, minValueY, maxValueY, width, height, 2, LineStyle.Solid, firstPlotColor4, context);
