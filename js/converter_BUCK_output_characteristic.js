...
function converter_BUCK_output_characteristic(width, height, inputMin, inputMax, inputStep, inputDefaultValue, minValueX, maxValueX, precisionX, minValueY, maxValueY, precisionY, gridHorizontalSpace, gridVerticalSpace, graduationHorizontalSpace, graduationVerticalSpace, firstPlotColor, secondPlotColor, secondPlotColor2, secondPlotColor3) {
    ...
    var container = createDiv("BUCK_output");
    ...
    valueSlider.oninput = function () {
        ...
        values = calculateBuckOutputCharacteristic(this.value, minValueX, maxValueX, 0.001,);
        values2 = calculateBuckOutputCharacteristicLine1(this.value, minValueX, maxValueX, 0.01);
        values3 = calculateBuckOutputCharacteristicLine2(this.value, minValueX, maxValueX, 0.01);
