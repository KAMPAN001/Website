...
function converter_BOOST_continuous_operation_in_time(width, height, inputMin, inputMax, inputStep, inputDefaultValue, minValueX, maxValueX, precisionX, minValueY, maxValueY, precisionY, minValueX2, maxValueX2, precisionX2, minValueY2, maxValueY2, precisionY2, gridHorizontalSpace, gridVerticalSpace, gridHorizontalSpace2, gridVerticalSpace2, graduationHorizontalSpace, graduationVerticalSpace, graduationHorizontalSpace2, graduationVerticalSpace2, inputMin2, inputMax2, inputStep2, inputDefaultValue2, firstPlotColor, firstPlotColor2, firstPlotColor3, firstPlotColor4, firstPlotColor5, firstPlotColor6, secondPlotColor, secondPlotColor2, secondPlotColor3) {
    ...
    valueSlider.oninput = function () {
        ...
        values = calculateBoostVL(this.value, minValueX, maxValueX, 0.001, valueSlider2.value);
        values2 = calculateBoostVD(this.value, minValueX, maxValueX, 0.001, valueSlider2.value);
        values3 = calculateBoostVT(this.value, minValueX, maxValueX, 0.001, valueSlider2.value);
        values4 = calculateBoostIL(this.value, minValueX, maxValueX, 0.001, valueSlider2.value);
        values5 = calculateBoostIT(this.value, minValueX, maxValueX, 0.001, valueSlider2.value);
        values6 = calculateBoostID(this.value, minValueX, maxValueX, 0.001, valueSlider2.value);
